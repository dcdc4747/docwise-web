...
| GitHub 用户名 | 称呼 | 真实姓名 | 负责模块 |
|---|---|---|---|
| dcdc4747 | 邹州 | 邹州 | 项目负责人 / 后端 / 仓库管理 / README / 密钥安全 / 验收（阶段 0 兼任） |
| eternal-pudding | 小时 | 时天赐 | 前端负责人（Vue3 + Naive UI 首页） |
| Niluf-06 | 小符 | 符霖 | 视觉三方快测（对比表、结论） |
| King-Rosamist | 小徐 | 徐金玥 | 测试样本与素材准备（协作者邀请已发出） |
| cshi0827 | 小陈 | 陈石 | 阶段 0 暂不参与，后续再安排 |
